...
function FileItem({ file }) {
  ...
  const image="/" + file.type + ".png"
    ...
    const momentDate = moment("Nov 23 2020", "MMM DD YYYY"); // RFC2822
  ...
  return (
    ...
    p-3 rounded-md transition-all duration-75"
    ...
    >
      ...
      <div className="grid grid-cols-2 place-content-start gap-1">
